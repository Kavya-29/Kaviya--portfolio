          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
              ...
              <ul className="space-y-1 text-slate-300">
                ...
                <li>
                  <span className="text-slate-400">CGPA (up to Sem 6):</span>{" "}
                  8.46 / 10
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
              ...
              <p className="text-slate-300 text-sm">
                ...
                where I worked on a voice calculator project using socket
                programming with Python and Java, focusing on client–server
                communication and clean backend logic.
              </p>
            </div>
