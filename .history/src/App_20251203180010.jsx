        ...
        <div className="max-w-5xl w-full pt-24 pb-12 grid md:grid-cols-[3fr,2fr] gap-8 items-center">
          ...
          >
            ...
            <div className="relative border-l border-slate-700/70 pl-4 space-y-5">
              {/* Education */}
              <div className="relative">
                <div className="absolute -left-2 top-1 h-3 w-3 rounded-full bg-fuchsia-400 shadow-[0_0_10px_rgba(232,121,249,0.7)]" />
              ...
              {/* Internship */}
              <div className="relative">
                <div className="absolute -left-2 top-1 h-3 w-3 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,0.7)]" />
                <p className="text-xs uppercase tracking-wide text-slate-400 mb-1">
                  Internship
                </p>
                <p className="text-sm text-slate-200 font-medium">
                  Izeon Innovative Pvt. Ltd. – 4 weeks
                </p>
                <p className="text-xs text-slate-300 mt-1">
                  Worked on a voice calculator using socket programming with
              ...
              {/* Current focus */}
              <div className="relative">
                <div className="absolute -left-2 top-1 h-3 w-3 rounded-full bg-sky-400 shadow-[0_0_10px_rgba(56,189,248,0.7)]" />
                <p className="text-xs uppercase tracking-wide text-slate-400 mb-1">
                  Current focus
                </p>
