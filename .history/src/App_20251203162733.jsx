...
function App() {
  ...
  const skillLogos = [
    ...
    { src: "/icons/socket.svg", label: "Socket Programming" },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden">
      ...
      >
        <div className="max-w-5xl w-full pt-24 pb-12 grid md:grid-cols-[3fr,2fr] gap-8 items-center">
          ...
          {/* Hero photo / card with glowing moving background */}
          <motion.div
  ...
  <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
    ...
    <ul className="space-y-1 text-slate-300">
      <li>
        <span className="text-slate-400">Degree:</span> B.Tech Artificial
        Intelligence and Data Science
      </li>
      <li>
        <span className="text-slate-400">College:</span> Francis Xavier
        Engineering College
      </li>
      <li>
        <span className="text-slate-400">CGPA (up to Sem 6):</span> 8.46 / 10
      </li>
    </ul>
  </div>
  ...
  <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
    ...
    <p className="text-slate-300 text-sm">
      Completed a 4-week internship at Izeon Innovative Pvt. Ltd., where I
      worked on a voice calculator project using socket programming with
      Python and Java, focusing on client–server communication and clean
      backend logic.
    </p>
  </div>

  {/* Current focus – added back */}
  <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
    <h3 className="text-sky-300 text-sm font-semibold mb-2">
      Current focus
    </h3>
  ...
  {/* Certifications */}
  <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4">
    <h3 className="text-violet-300 text-sm font-semibold mb-2">
      Certifications
    </h3>
    <ul className="list-disc list-inside text-slate-300 space-y-1">
      <li>Internship certification – Izeon Innovative Pvt. Ltd.</li>
      <li>Online courses related to Python / AI (details on request)</li>
    </ul>
  </div>
</div>
      ...
      <Section id="skills" title="Skills" eyebrow="STACK">
        {/* Logos row directly under heading */}
        <motion.div
        ...
        >
          {skillLogos.map((skill) => (
            ...
            >
              <div className="h-10 w-10 rounded-full bg-slate-900/80 border border-slate-700/80 flex items-center justify-center overflow-hidden">
                <img
                  src={skill.src}
                  alt={skill.label}
