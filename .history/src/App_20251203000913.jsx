...
function App() {
  ...
  const handleWhatsApp = () => {
    const phone = "918148812904"; // your number with country code
  ...
  const handleEmailSubmit = (e) => {
    ...
    window.location.href = `mailto:kaviyasivakumar2911@gmail.com?subject=${subject}&body=${body}`;
  };
        ...
        <div className="max-w-5xl w-full pt-24 pb-12 grid md:grid-cols-[3fr,2fr] gap-8 items-center">
          ...
          >
            ...
            <p className="text-slate-300 mb-4 text-sm md:text-base max-w-xl">
              ...
              applications to small tools that automate everyday tasks, with
              Python as my main stack.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-950/80 border border-slate-800 rounded-3xl p-4 w-64 h-80 flex flex-col items-center shadow-xl shadow-sky-500/30">
                <motion.div
                  ...
                  className="w-36 h-36 rounded-full overflow-hidden bg-slate-800 mb-3 border border-slate-600/80"
                >
                  <img
                    src="/profile.jpg"
                    alt="Kaviya profile"
...
<Section id="skills" title="Skills" eyebrow="STACK">
  <motion.div
    ...
    transition={{ duration: 0.6 }}
    viewport={{ once: true }}
    className="grid md:grid-cols-3 gap-6 text-sm mb-6"
  >
    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4">
      ...
      <ul className="space-y-1 text-slate-200">
        ...
        <li>TensorFlow / Keras mini projects</li>
      </ul>
    </div>
  </motion.div>


        {/* Tech stack icons row (badges) */}
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="flex flex-wrap gap-2 text-[11px] text-slate-200"
        >
          {[
  "🐍 Python",
  "☕ Java",
  ...
  "📊 Streamlit",
            ...
            <span
              key={tool}
              className="px-2.5 py-1 rounded-full bg-slate-900/80 border border-slate-700/80"
            >
              {tool}
            </span>
          ))}
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <button
                ...
                className="px-3 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-xs font-medium text-slate-950 shadow-md shadow-emerald-500/30"
              >
                WhatsApp me
              </button>
            </div>
  ...
  <button
    onClick={() =>
      window.open(
        "https://wa.me/918148812904?text=Hi%20Kaviya,%20I%20saw%20your%20portfolio.",
        "_blank"
      )
    }
    className="px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-sm font-medium text-slate-950 shadow-md shadow-emerald-500/30"
  >
    💬 WhatsApp Me
  </button>
</div>
