...
function App() {
  ...
  const projects = [
    {
      ...
      badge: "Python • Voice",
      desc: "A voice-based calculator that converts spoken expressions into operations and provides clear results in a simple interface.",
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden">
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-slate-950/80 border border-slate-800 rounded-3xl p-4 w-64 h-80 flex flex-col items-center shadow-xl shadow-sky-500/30">
                <div className="w-32 h-32 rounded-full overflow-hidden bg-slate-800 mb-3 border border-slate-600/80 flex items-center justify-center">
                  <img
                    src="/profile.jpg"
                    alt="Kaviya profile"
      ...
      <Section id="about" title="Profile" eyebrow="ABOUT">
        ...
        >
          <div className="space-y-3">
            ...
            <p>
              Most of my mini projects combine{" "}
              <span className="text-sky-300">
                Python backends, simple user interfaces and basic AI concepts
              </span>
      ...
      {/* PROJECTS */}
      <Section id="projects" title="SProjects" eyebrow="WORK">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
